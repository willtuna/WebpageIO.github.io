        ...
        data: {
            ...
            datasets: [{
            ...
            },
                {
                    label: "本月預算",
                    lineTension: .3,
                    backgroundColor: "rgba(1,17,16,0.0)",
                ...
                },
                {
                    label: "本月累計支出",
                    lineTension: .3,
                    backgroundColor: "rgba(12,170,160,0.5)",
                    borderColor: "rgba(12,170,160,0.5)",
                    pointRadius: 5,
...
var lineChartUpdate = function (obj_label_data) {
    ...
    for (var i = obj_label_data.date.length - 1; i >= 0; --i) {
        ...
        myLineChart.data.datasets[0].data.push(obj_label_data.price[i]);
